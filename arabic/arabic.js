...
const questions = [
  ...
  {
    text: "ما هو نوع شركتك أو علامتك التجارية؟",
    type: "choice",
    options: ["شركة ناشئة", "شركة", "علامة تجارية خاصة", "مطعم/مقهى", "عيادة", "مراكز العناية بالسيارات", "اخرى"]
  },
  {
    text: "هل لديك موقع إلكتروني أو نطاق حالياً؟",
    type: "choice",
    options: ["نعم", "لا", "نطاق فقط"]
  },
  {
    text: "ما الخدمة التي تحتاجها؟",
    type: "choice",
    options: [
  "تطوير المواقع",
  "صناعة محتوى المواقع",
  "تصميم واجهات وتجربة المستخدم",
  "ربط أنظمة إدارة المحتوى",
  "الشعارات والهوية البصرية",
  "حضور رقمي متكامل"
]
  },
  {
    text: "ما الأسلوب التصميمي الذي يعكس الشكل الذي تريده لموقعك؟",
type: "choice",
options: [
  "طابع فاخر",
  "حديث ونظيف",
  ...
  {
    text: "صف لنا باختصار ما الذي ترغب أن نقوم بتصميمه أو تطويره لك.",
    type: "text"
  },
  {
    text: "هل تفضل اجتماعًا عبر الإنترنت أو اجتماعًا شخصيًا?",
    type: "choice",
    options: ["اجتماع عبر الإنترنت", "اجتماع شخصي"]
  },
  {
    text: "اختر التاريخ والوقت المفضلين للاجتماع.",
    type: "datetime"
  }
];
...
function showQuestion() {
  ...
  typeQuestion(current.text, () => {
    ...
    if (current.type === "choice") {
      ...
      if (current.text.includes("الأسلوب التصميمي")) {
        const previewBtn = document.createElement("button");
        previewBtn.type = "button";
        previewBtn.className = "style-preview-btn";
        previewBtn.textContent = "عرض أمثلة التصميم";
